...
local ScrollView = ISUIElement:derive("ScrollView");

function ScrollView:new(x, y, w, h)
	local o = {};
...
function ScrollView:createChildren()
...
function ScrollView:sendScrollbarsToFront()
...
function ScrollView:isChildVisible(child)
...
function ScrollView:onMouseWheel(del)
...
function ScrollView:updateScroll()
...
function ScrollView:resetScroll()
    self:setXScroll(0);
    self:setYScroll(0);
    self:updateScroll();
end
...
function ScrollView:ensureChildIsVisible(child, padding)
